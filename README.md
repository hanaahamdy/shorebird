...
> 💡 **ملحوظة:** باستخدام [Shorebird Code Push](https://pub.dev/packages/shorebird_code_push)، ممكن نفحص وجود تحديثات جديدة بدون ما نقفل التطبيق، ولو فيه تحديث فعلاً، التطبيق بيعيد تشغيل نفسه بشكل تلقائي بعد تحميل التحديث.
